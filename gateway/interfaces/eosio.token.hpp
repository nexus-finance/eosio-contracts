...
namespace eosio {
   ...
   class [[eosio::contract("eosio.token")]] token : public contract {
      public:
         ...
         // custom modification to not throw on non-existant row
         static asset get_balance_or_default( const name& token_contract_account, const name& owner, const symbol& sym )
         {
            accounts accountstable( token_contract_account, owner.value );
